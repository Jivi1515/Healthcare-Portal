...
hospitals: Stores comprehensive hospital data.
...
Install XAMPP: Download and install XAMPP for your OS.
Clone the Repository:
git clone [https://github.com/your-username/healthcare-portal.git](https://github.com/your-username/healthcare-portal.git)
Move Files: Copy the project folder into the htdocs directory of your XAMPP installation (usually C:\xampp\htdocs).
